...
class Main
{
    ...
    public static void main(String args[]){
        ...
        StaticClassDemo.NestedStaticClass printer = new StaticClassDemo.NestedStaticClass();
        ...
        StaticClassDemo outer = new StaticClassDemo();
        StaticClassDemo.InnerClass inner  = outer.new InnerClass();
        ...
        // Inner class
        StaticClassDemo.InnerClass innerObject = new StaticClassDemo().new InnerClass();
