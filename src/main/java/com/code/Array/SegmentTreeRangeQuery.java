...
/**
 * @author prem chand shah on 02-07-2018
 * @project myJava
 */
public class SegmentTreeRangeQuery {
    ...
    /**
     * Length of array will be
     * 2*lengthOfArray-1 >> in length is power of 2(l=4 (2*4-1=7))
     * if not power of 2 find next length that is power of 2 and 2*-1 (l=5 (2*8-1=15))
     * */
    ...
    public static void main(String args[]) {
        ...
        int n = arr.length;
        SegmentTreeRangeQuery tree = new SegmentTreeRangeQuery();
